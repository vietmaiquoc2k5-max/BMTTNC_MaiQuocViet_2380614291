...
def encrypt_message(key, message):
    ...
    return cipher.iv + ciphertext  # Đã sửa: Thêm dấu + để nối iv và ciphertext
    ...
    try:
        while True:
            ...
            for client, key in clients:
                if client != client_socket:  # Đã sửa: Đổi '=' thành '!=' để không gửi lại cho chính người gửi
...
while True:
    ...
    # Đã sửa: Cú pháp target= và truyền args
